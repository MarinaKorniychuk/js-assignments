...
## Javascript Assignments  [![Build Status](https://travis-ci.org/MarinaKorniychuk/js-assignments.svg?branch=master)](https://travis-ci.org/MarinaKorniychuk/js-assignments)
